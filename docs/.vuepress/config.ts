...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "Yang's blog",
      description: '杨雨翔的个人博客，专注于前端技术的总结和生活的分享',
    }
  },
  ...
  themeConfig: {
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-QQ',
          title: 'QQ',
          link: 'http://wpa.qq.com/msgrd?v=3&uin=1372201820&site=qq&menu=yes',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        '杨雨翔 | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '杨雨翔,前端博客,个人技术博客,前端,前端开发,前端框架,web前端,前端面试题,技术文档,学习,面试,JavaScript,js,ES6,TypeScript,vue,python,css3,html5,Node,git,github,markdown',
      },
    ],
    ['meta', { name: 'baidu-site-verification', content: 'code-qMro5hDelB' }], // 百度统计的站长验证
